# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-03 14:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='pedigree',
            index=models.Index(fields=['case'], name='main_pedigr_case_c9644c_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddField(
            model_name='main',
            name='case',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Pedigree', to_field='case'),
        ),
        migrations.AddIndex(
            model_name='hpo',
        ...
        migrations.AddIndex(
            model_name='main',
            index=models.Index(fields=['case', 'frequency', 'homozygous', 'effect'], name='main_main_case_id_ac8fd0_idx'),
        ),
        migrations.AddIndex(
            model_name='main',
        ...
        migrations.AlterUniqueTogether(
            name='main',
            unique_together=set([('chromosome', 'position', 'reference', 'alternative', 'case')]),
        ),
    ]
