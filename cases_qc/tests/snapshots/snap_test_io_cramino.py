...
snapshots['CraminoLoadTest::test_load 2'] = {
    ...
    'summary': [
        ...
        GenericRepr("CraminoSummaryRecord(key='Mean coverage', value=64.35)"),
        GenericRepr("CraminoSummaryRecord(key='Yield [Gb] (>25kb)', value=12.05)"),
        GenericRepr("CraminoSummaryRecord(key='N50', value=9723)"),
        GenericRepr("CraminoSummaryRecord(key='N75', value=3929)"),
        GenericRepr("CraminoSummaryRecord(key='Median length', value=2713.0)"),
        GenericRepr("CraminoSummaryRecord(key='Mean length', value=4854)"),
        GenericRepr("CraminoSummaryRecord(key='Median identity', value=98.48)"),
