...
snapshots['TestSeqvarsQuerySettingsClinvar::test_from_presets allow_conflicting_interpretations'] = False

snapshots['TestSeqvarsQuerySettingsClinvar::test_from_presets clinvar_germline_aggregate_description'] = [
...
snapshots['TestSeqvarsQuerySettingsColumns::test_from_presets column_settings'] = [
    GenericRepr("SeqvarsColumnConfigPydantic(name='chromosome', label='Chromosome', description=None, width=300, visible=True)")
]
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_1_de_novo sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'variant',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_2_dominant sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'het',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_3_homozygous_recessive sample_genotype_choices'] = [
    {
        'enabled': True,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_4_compound_heterozygous_recessive sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'recessive_index',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_5_recessive sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'recessive_index',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_6_x_recessive sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'recessive_index',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsGenotype::test_from_presets_7_affected_carriers sample_genotype_choices'] = [
    {
        'enabled': True,
        'genotype': 'variant',
        'include_no_call': False,
...
snapshots['TestSeqvarsQuerySettingsPhenotypePrio::test_from_presets phenotype_prio_algorithm'] = 'HiPhive'
