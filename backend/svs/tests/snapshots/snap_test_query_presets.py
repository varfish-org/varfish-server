...
snapshots["TestQuickPresets::testToSettingsDefaults 1"] = {
    ...
    "genotype_criteria": [
        ...
        GenericRepr(
            "GenotypeCriteria(genotype=<GenotypeChoice.NON_VARIANT: 'non-variant'>, select_sv_sub_type=['DEL', 'DEL:ME', 'DEL:ME:SVA', 'DEL:ME:L1', 'DEL:ME:ALU', 'DUP', 'DUP:TANDEM', 'CNV'], select_sv_min_size=None, select_sv_max_size=None, gt_one_of=['0/0', '0|0', '0', './0', '0/.', '0|.', '.|0', './.', '.|.', '.'], max_brk_segdup=None, max_brk_repeat=None, max_brk_segduprepeat=None, min_gq=None, min_pr_cov=None, max_pr_cov=None, min_pr_ref=None, max_pr_ref=None, min_pr_var=None, max_pr_var=None, min_sr_cov=None, max_sr_cov=None, min_sr_ref=None, max_sr_ref=None, min_sr_var=None, max_sr_var=None, min_srpr_cov=None, max_srpr_cov=None, min_srpr_ref=None, max_srpr_ref=None, min_srpr_var=None, max_srpr_var=1, min_sr_ab=None, max_sr_ab=None, min_pr_ab=None, max_pr_ab=None, min_srpr_ab=None, max_srpr_ab=None, min_rd_dev=None, max_rd_dev=0.2, min_amq=None, max_amq=None, missing_gt_ok=True, missing_gq_ok=True, missing_pr_ok=True, missing_sr_ok=True, missing_srpr_ok=True, missing_rd_dev_ok=True, missing_amq_ok=True, comment='Non-variant genotype with high-confidence filter (CNV)')"
        ),
        GenericRepr(
            "GenotypeCriteria(genotype=<GenotypeChoice.NON_VARIANT: 'non-variant'>, select_sv_sub_type=['INV', 'INS', 'INS:ME', 'INS:ME:SVA', 'INS:ME:L1', 'INS:ME:ALU', 'BND'], select_sv_min_size=None, select_sv_max_size=None, gt_one_of=['0/0', '0|0', '0', './0', '0/.', '0|.', '.|0', './.', '.|.', '.'], max_brk_segdup=None, max_brk_repeat=None, max_brk_segduprepeat=None, min_gq=None, min_pr_cov=None, max_pr_cov=None, min_pr_ref=None, max_pr_ref=None, min_pr_var=None, max_pr_var=None, min_sr_cov=None, max_sr_cov=None, min_sr_ref=None, max_sr_ref=None, min_sr_var=None, max_sr_var=None, min_srpr_cov=None, max_srpr_cov=None, min_srpr_ref=None, max_srpr_ref=None, min_srpr_var=None, max_srpr_var=1, min_sr_ab=None, max_sr_ab=None, min_pr_ab=None, max_pr_ab=None, min_srpr_ab=None, max_srpr_ab=None, min_rd_dev=None, max_rd_dev=0.2, min_amq=None, max_amq=None, missing_gt_ok=True, missing_gq_ok=True, missing_pr_ok=True, missing_sr_ok=True, missing_srpr_ok=True, missing_rd_dev_ok=True, missing_amq_ok=True, comment='Non-variant genotype with high-confidence filter (non-CNV)')"
        ),
        GenericRepr(
...
snapshots["TestQuickPresets::testValueDominant 1"] = GenericRepr(
    "QuickPresets(label='CNV dominant', inheritance=<Inheritance.AFFECTED_CARRIERS: 'affected_carriers'>, frequency=<Frequency.STRICT: 'strict'>, impact=<Impact.EXONIC: 'exonic'>, sv_type=<SvType.CNVS_EXTRA_LARGE: 'cnvs_extra_large'>, chromosomes=<Chromosomes.WHOLE_GENOME: 'whole_genome'>, regulatory=<Regulatory.DEFAULT: 'default'>, tad=<Tad.DEFAULT: 'default'>, known_patho=<KnownPatho.DEFAULT: 'default'>, genotype_criteria=<GenotypeCriteriaDefinitions.SVISH_HIGH: 'svish_high'>, database=<Database.REFSEQ: 'refseq'>)"
)
...
snapshots["TestQuickPresets::testValueHomozygousRecessive 1"] = GenericRepr(
    "QuickPresets(label='homozygous high quality', inheritance=<Inheritance.HOMOZYGOUS_RECESSIVE: 'homozygous_recessive'>, frequency=<Frequency.RELAXED: 'relaxed'>, impact=<Impact.ANY: 'any'>, sv_type=<SvType.ANY: 'any'>, chromosomes=<Chromosomes.WHOLE_GENOME: 'whole_genome'>, regulatory=<Regulatory.DEFAULT: 'default'>, tad=<Tad.DEFAULT: 'default'>, known_patho=<KnownPatho.DEFAULT: 'default'>, genotype_criteria=<GenotypeCriteriaDefinitions.SVISH_HIGH: 'svish_high'>, database=<Database.REFSEQ: 'refseq'>)"
)
...
snapshots["TestQuickPresets::testValueXRecessive 1"] = GenericRepr(
    "QuickPresets(label='X-recessive high quality', inheritance=<Inheritance.X_RECESSIVE: 'x_recessive'>, frequency=<Frequency.RELAXED: 'relaxed'>, impact=<Impact.ANY: 'any'>, sv_type=<SvType.ANY: 'any'>, chromosomes=<Chromosomes.X_CHROMOSOME: 'x_chromosome'>, regulatory=<Regulatory.DEFAULT: 'default'>, tad=<Tad.DEFAULT: 'default'>, known_patho=<KnownPatho.DEFAULT: 'default'>, genotype_criteria=<GenotypeCriteriaDefinitions.SVISH_HIGH: 'svish_high'>, database=<Database.REFSEQ: 'refseq'>)"
)
