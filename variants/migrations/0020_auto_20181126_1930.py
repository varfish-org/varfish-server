    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sodar_uuid', models.UUIDField(default=uuid.uuid4, help_text='Job Specialization SODAR UUID', unique=True)),
                ('bg_job', models.ForeignKey(help_text='Background job for state etc.', on_delete=django.db.models.deletion.CASCADE, related_name='compute_project_variants_stats', to='bgjobs.BackgroundJob')),
            ],
        ...
        migrations.AlterField(
            ...
            name='stats',
            field=models.ForeignKey(help_text='Pedigree relatedness information', on_delete=django.db.models.deletion.CASCADE, related_name='relatedness', to='variants.CaseVariantStats'),
        ),
        migrations.AddField(
            model_name='projectvariantstats',
            name='project',
            field=models.OneToOneField(help_text='The variant statistics object for this projects', on_delete=django.db.models.deletion.CASCADE, related_name='variant_stats', to='projectroles.Project'),
        ),
        migrations.AddField(
            model_name='projectrelatedness',
            name='stats',
            field=models.ForeignKey(help_text='Pedigree relatedness information', on_delete=django.db.models.deletion.CASCADE, related_name='relatedness', to='variants.ProjectVariantStats'),
        ),
        migrations.AddField(
