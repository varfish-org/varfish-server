<template>
  <div class="small font-italic p-2 bg-light">
    ...
    threshold. The checkboxes enable (<i
      class="iconify"
      data-icon="fa-regular:check-square"
    ></i
    >) or disable (<i class="iconify" data-icon="fa-regular:square"></i>)
    filtration based on the population frequencies of the given database. You
    can provide the number of carriers with maximal heterozygous/homozygous
    (respectively: -plasmid) state or population frequencies. For the in-house
    DB, you can only filter based on carrier state as currently it is tracked
    how many carriers have sufficient coverage for each variant.
    <span v-if="store.case.release === 'GRCh37'"></span>
    <span v-else-if="store.case.release === 'GRCh38'">
    ...
    <div v-else class="alert alert-danger">
      ...
      Genomebuild variable is unknown (<strong>{{ store.case.release }}</strong
  ...
  >
    ...
    <tbody>
      <tr v-show="store.case.release === 'GRCh37'">
        <td>
          <input
            v-model="store.querySettings.thousand_genomes_enabled"
            type="checkbox"
          />
        </td>
        ...
        <td>
          <input
            v-model="store.querySettings.thousand_genomes_homozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.thousand_genomes_heterozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.thousand_genomes_hemizygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.thousand_genomes_frequency"
            type="number"
      ...
      <tr v-show="store.case.release === 'GRCh37'">
        <td>
          <input v-model="store.querySettings.exac_enabled" type="checkbox" />
        </td>
        ...
        <td>
          <input
            v-model="store.querySettings.exac_homozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.exac_heterozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.exac_hemizygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.exac_frequency"
            type="number"
      ...
      <tr>
        <td>
          <input
            v-model="store.querySettings.gnomad_exomes_enabled"
            type="checkbox"
          />
        </td>
        <td
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_exomes_homozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_exomes_heterozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_exomes_hemizygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_exomes_frequency"
            type="number"
      ...
      <tr>
        <td>
          <input
            v-model="store.querySettings.gnomad_genomes_enabled"
            type="checkbox"
          />
        </td>
        <td
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_genomes_homozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_genomes_heterozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_genomes_hemizygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.gnomad_genomes_frequency"
            type="number"
      ...
      <tr>
        <td>
          <input
            v-model="store.querySettings.inhouse_enabled"
            type="checkbox"
          />
        </td>
        ...
        <td>
          <input
            v-model="store.querySettings.inhouse_homozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.inhouse_heterozygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.inhouse_hemizygous"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.inhouse_carriers"
            type="number"
      ...
      <tr>
        <td>
          <input v-model="store.querySettings.mtdb_enabled" type="checkbox" />
        </td>
        ...
        <td>
          <input
            v-model="store.querySettings.mtdb_count"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.mtdb_frequency"
            type="number"
      ...
      <tr>
        <td>
          <input
            v-model="store.querySettings.helixmtdb_enabled"
            type="checkbox"
          />
        </td>
        <td title="Mitochondrial frequency database">
        ...
        <td>
          <input
            v-model="store.querySettings.helixmtdb_hom_count"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.helixmtdb_het_count"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.helixmtdb_frequency"
            type="number"
      ...
      <tr>
        <td>
          <input
            v-model="store.querySettings.mitomap_enabled"
            type="checkbox"
          />
        </td>
        <td title="Mitochondrial frequency database">
        ...
        <td>
          <input
            v-model="store.querySettings.mitomap_count"
            type="number"
        ...
        <td>
          <input
            v-model="store.querySettings.mitomap_frequency"
            type="number"
