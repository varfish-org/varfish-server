...
const variantValidatorState = ref<VariantValidatorStates>(
  VariantValidatorStates.Initial,
)
...
<template>
  <div class="m-2">
    <p v-if="variantValidatorState === VariantValidatorStates.Done">
      <span class="badge-group" v-if="variantValidatorResults.metadata">
        <span class="badge badge-dark">VariantValidator HGVS Version</span>
        <span class="badge badge-info">{{
          variantValidatorResults.metadata.variantvalidator_hgvs_version
        }}</span>
      </span>
      <span class="badge-group" v-if="variantValidatorResults.metadata">
        <span class="badge badge-dark">VariantValidator Version</span>
        <span class="badge badge-info">{{
          variantValidatorResults.metadata.variantvalidator_version
        }}</span>
      </span>
    </p>
    <div
      class="container-fluid"
      v-if="variantValidatorState === VariantValidatorStates.Done"
    >
                ...
                <div class="card">
                  ...
                  <table class="card-body table table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      >
                        <td>
                          Protein <span class="badge badge-dark">:p.</span>
                        </td>
                        <td>
