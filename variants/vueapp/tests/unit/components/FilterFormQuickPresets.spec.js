// import FilterFormQuickPresets from '@variants/components/FilterFormQuickPresets.vue'
...
// TODO [TEST_STUB] Mock pinia store
describe('FilterFormQuickPresets.vue', () => {
  test('quality singleton with help', () => {
    // const wrapper = shallowMount(FilterFormQuickPresets, {
    //   props: {
