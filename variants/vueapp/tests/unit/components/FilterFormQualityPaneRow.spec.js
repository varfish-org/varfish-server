import FilterFormQualityPaneRow from '@variants/components/FilterFormQualityPaneRow.vue'
...
describe('FilterFormQualityPaneRow.vue', () => {
  test('quality row singleton', () => {
    ...
    expect(inputs[0].element.value).toBe(String(dataSingleton.qualMinDpHet))
    expect(inputs[1].element.value).toBe(String(dataSingleton.qualMinDpHom))
    expect(inputs[2].element.value).toBe(String(dataSingleton.qualMinAb))
    expect(inputs[3].element.value).toBe(String(dataSingleton.qualMinGq))
    expect(inputs[4].element.value).toBe(String(dataSingleton.qualMinAd))
