...
describe('VariantDetailsLinkOuts.vue', () => {
  test('full list', () => {
    ...
    expect(links[21].text()).toBe('Human Splicing Finder')
    expect(links[22].text()).toBe('varSEAK Splicing')
    expect(links[23].text()).toBe('UMD Predictor')
  ...
  test('minimal list', () => {
    ...
    expect(links[15].text()).toBe('PubMed+Pheno')
    expect(links[16].text()).toBe('UCSC')
    expect(links[17].text()).toBe('EnsEMBL')
    expect(links[18].text()).toBe('DGV')
    expect(links[19].text()).toBe('gnomAD')
    expect(links[20].text()).toBe('Human Splicing Finder')
    expect(links[21].text()).toBe('varSEAK Splicing')
    expect(links[22].text()).toBe('UMD Predictor')
