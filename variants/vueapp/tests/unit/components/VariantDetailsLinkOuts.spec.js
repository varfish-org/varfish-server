...
describe('VariantDetailsLinkOuts.vue', () => {
  ...
  test('minimal list', () => {
    ...
    expect(links[20].text()).toBe('MT 85')
    expect(links[21].text()).toBe('MT 2021')
    expect(links[22].text()).toBe('Human Splicing Finder')
    expect(links[23].text()).toBe('varSEAK Splicing')
    expect(links[24].text()).toBe('UMD Predictor')
