# VarFish documentation build configuration file, created by
# sphinx-quickstart.
#
...
version = ".".join(varfish.__version__.split(".")[:2])
# The full version, including alpha/beta/rc tags
release = varfish.__version__
# Fixup if dirty.
if ".dirty" in release:
...
latex_documents = [
    ("index", "varfish.tex", "VarFish Documentation", """BIH Core Unit Bioinformatics""", "manual")
]
