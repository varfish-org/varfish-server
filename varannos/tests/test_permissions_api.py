...
class TestVarAnnoSetApiView(TestProjectAPIPermissionBase):
    ...
    def test_list(self):
        url = reverse(
            "varannos:api-varannoset-listcreate", kwargs={"project": self.project.sodar_uuid},
        )
        good_users = [
            self.superuser,
        ]
    ...
    def test_update(self):
        ...
        self.assert_response(
            url, good_users, 200, method="PUT", data=data,
        )
        self.assert_response(
            url, bad_users_401, 401, method="PUT", data=data,
        )
        self.assert_response(
            url, bad_users_403, 403, method="PUT", data=data,
        )
    ...
    def test_destroy(self):
        ...
        self.assert_response(
            url, good_users, 204, method="DELETE",
        )
        self.assert_response(
            url, bad_users_401, 401, method="DELETE",
        )
        self.assert_response(
            url, bad_users_404, 404, method="DELETE",
        )
