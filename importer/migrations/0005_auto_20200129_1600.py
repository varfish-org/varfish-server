...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name="genotypefile", unique_together=set([("variant_set_import_info", "md5")]),
        ),
        migrations.AlterUniqueTogether(
            name="effectfile", unique_together=set([("variant_set_import_info", "md5")]),
        ),
        migrations.AlterUniqueTogether(
            name="databaseinfofile", unique_together=set([("variant_set_import_info", "md5")]),
        ),
        migrations.AlterUniqueTogether(
            name="caseimportinfo", unique_together=set([("project", "name")]),
        ),
        migrations.AlterUniqueTogether(
            name="bamqcfile", unique_together=set([("case_import_info", "md5")]),
        ),
    ]
