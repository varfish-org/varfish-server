...
Please first download the `pfeiffer-singleton.vcf.gz <https://github.com/varfish-org/varfish-server/raw/main/docs_manual/assets/pfeiffer-singleton.vcf.gz>`_ file.
...
- A good next step is to try this again with the following `quartet VCF file <https://github.com/varfish-org/varfish-server/raw/main/docs_manual/assets/pfeiffer-quatro.vcf.gz>`_ which is again based on the public Corpasome data having the Pfeiffer variant spiked into one of the children as a *de novo* variant.
