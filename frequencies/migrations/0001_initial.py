...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['release', 'chromosome', 'position', 'reference', 'alternative'], name='frequencies_release_e5bf46_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['release', 'chromosome', 'position', 'reference', 'alternative'], name='frequencies_release_952459_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='gnomadgenomes',
            unique_together=set([('release', 'chromosome', 'position', 'reference', 'alternative')]),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['release', 'chromosome', 'position', 'reference', 'alternative'], name='frequencies_release_72be93_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='gnomadexomes',
            unique_together=set([('release', 'chromosome', 'position', 'reference', 'alternative')]),
        ...
        migrations.AddIndex(
            model_name='exac',
            index=models.Index(fields=['release', 'chromosome', 'position', 'reference', 'alternative'], name='frequencies_release_668614_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='exac',
            unique_together=set([('release', 'chromosome', 'position', 'reference', 'alternative')]),
